...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh ""mvn sonar:sonar \
          ...
          -Dsonar.host.url=http://54.82.124.88:9000 \
          -Dsonar.login=21277b5619951d0f811a41435bd2a85a927ea930"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#samuel-jenkins-cicd-pipeline-alert', //update and provide your channel name
